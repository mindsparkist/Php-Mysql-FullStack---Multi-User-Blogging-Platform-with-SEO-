        ...
        <div class="single-post-wrap page-wrap">
            <div class="post-head d-flex">
                <div class="header-inner align-self-center">
                    <h1 class="title">Privacy Policy for phptimes</h1>
                </div>
            </div>
            <div class="post-content m-auto">
                <p>At phptimes, accessible from http://localhost/blog/, one of our main priorities is the privacy of our
                    visitors. This Privacy Policy document contains types of information that is collected and recorded
                    by phptimes and how we use it.</p>

                <p>If you have additional questions or require more information about our Privacy Policy, do not
                    hesitate to contact us.</p>

                <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website
                    with regards to the information that they shared and/or collect in phptimes. This policy is not
                ...
                <p>phptimes follows a standard procedure of using log files. These files log visitors when they visit
                ...
                <p>Like any other website, phptimes uses 'cookies'. These cookies are used to store information
                ...
                <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
                    are used in their respective advertisements and links that appear on phptimes, which are sent
                ...
                <p>Note that phptimes has no access to or control over these cookies that are used by third-party
                    advertisers.</p>

                <h2>Third Party Privacy Policies</h2>

                <p>phptimes's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you
                ...
                <p>phptimes does not knowingly collect any Personal Identifiable Information from children under the age
