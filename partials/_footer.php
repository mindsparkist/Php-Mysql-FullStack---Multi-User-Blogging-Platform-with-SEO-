        ...
        <div class="row">
            <div class="col-md-3">
                <div class="widget widget_tag_cloud">
                    ...
                    <div class="tagcloud">
                        <?php
                         $conn = mysqli_connect('localhost', 'shuv', '123', 'php-blog');
                         $res = mysqli_query($conn, "SELECT categoryname FROM  categories");
                         while ($row=mysqli_fetch_assoc($res)) { ?>
                        <a href="category-business.php"><?= $row['categoryname']?></a>
                        <?php   } ?>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="widget widget_text">
                    <h4 class="widget-title">The Phptimes</h4>
                    <div class="textwidget">
                        <p>PhpTimes is a newspaper/magazine style highly content focus "CMS" theme. You can
            ...
            <div class="col">
                <div class="copyright-wrap text-center">
                    <div class="copyright-info">
                        Copyright &copy; 2021-<?= date('Y') ?> Compass Metal
                        Consulting Services-INDIA , All Rights Reserved
