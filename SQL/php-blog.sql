...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 11, 2022 at 03:06 PM
...
(4, '11/04/2022 05:39:07 pm', 'Qabeel Venkatesh', '$2y$10$WHWnVJRt/pkGfPoIa8mH1uEUNu.9.OFjmc6kS/wayO1g6qYxSD55m', 'qabeel.v22@mailgen.club', 'root'),
(5, '11/04/2022 05:39:38 pm', 'Sid Ramkissoon', '$2y$10$lzMr1LlYZ3FtDpwVI1De0uyItIMrfAvGir5Vax21hOlFfNz55GatK', 'sidramkissoon22@mailgen.xyz', 'root');
...
(35, '27/03/2022 05:12:50 pm', 'Tucker Carlson', 'Breaking News'),
(36, '27/03/2022 05:13:06 pm', 'John Oliver', 'Markets'),
(37, '27/03/2022 05:14:53 pm', 'Vladimir Putin', 'Geo Politics');
...
(38, '04/04/2022 07:36:39', 'good performance.', 'D Chakraborty', 'chakrabortyshuvradip@gmail.com', 'ON', 18),
(39, '10/04/2022 02:14:16', 'nice', 'debabrata', 'debabratamukherjee2013@gmail.com', 'ON', 23);
...
(11, 'Shuvrad', 'chakrabortyshuvradip@gmail.com', 'Dashboard !', 'This module contains details about News Stories, i.e. Various Kinds of Stories. Like Latest Stories, Breaking News, Sports Stories. Here Readers can Read, Comment Listen to Audio. He can Share To Facebook, Twitter, LinkedIn and pinterest.');
...
INSERT INTO `transactions` (`id`, `name`, `email`, `mob`, `adderss`, `company`, `amount`, `payment_status`, `payment_Id`, `addedOn`, `monthly`) VALUES
(2, 'Bhairavi Krishnamurthy', 'b.krishnamurthy1604@mailgen.xyz', '04820844265', '87, Anshula Villas, Aundh', 'Srivastava Ltd', 200, 'complete', 'pay_JJzV2LqYTkLaES', '2022-04-16 12:14:03', 'false'),
(4, 'Juhi Divan', 'jd@mailgen.fun', '01432758487', '57, Sapna Apartments, Virar', 'Tata', 599, 'complete', 'pay_JJzq5KxMjoFO8Q', '2022-04-16 12:33:53', 'true'),
(5, 'Rita Yadav', 'ritay1604@mailgen.biz', '917162394952', '84, Kharadi,', 'Salvi', 1000, 'Incomplete', '', '2022-04-16 12:36:02', 'true'),
(6, 'Kajal Mahajan', 'kmahajan22@mailgen.xyz', '02554464458', '40, Chinchwad,', 'Batta', 852, 'complete', 'pay_JK00TX643fCDPc', '2022-04-16 12:43:52', 'true'),
(7, 'Jasmin Masih', 'j.masih@mailgen.info', '914116096844', '85, Ghalib Heights, AnkitaPur', 'Varghese', 269, 'complete', 'pay_JKoycoqwIagnHR', '2022-04-18 02:35:19', 'false'),
(11, 'Delilah King', 'chakrabortyshuvradip@gmail.com', '9083125548', '682 Grady Gateway', 'Goodwin', 100, 'complete', 'pay_JKw1gCZq3QJ6Vp', '2022-04-18 09:28:25', 'true'),
(12, 'Sameedha Date', 'sdate@mailgen.pro', '2852598628', '80, Zara Heights, Virar', 'Palan', 599, 'complete', 'pay_JOJ3lgTK0YrYMh', '2022-04-27 09:56:53', 'true'),
(13, 'Bryce Goyette', 'bryceg@mailgen.pw', '5494360090', '639 Hansen Rest', 'self employed', 200, 'complete', 'pay_JOJ7lVxDJKr8OR', '2022-04-27 10:00:56', 'false'),
(14, 'Siddharth Chowdhury', 'siddharthc22@mailgen.club', '9691702192', '11, Ganesh Heights, IndraniGunj', 'TATA', 199, 'Incomplete', '', '2022-04-27 10:04:41', 'false');
