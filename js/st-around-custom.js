    ...
    var themeApp = {
        ...
        mobileMenu: function () {
            ...
            $(li)
                ...
                .addClass("menu-item-has-children")
                .prepend(
                    '<span class="submenu-toggle-button"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M0 7.33l2.829-2.83 9.175 9.339 9.167-9.339 2.829 2.83-11.996 12.17z"/></svg></span>'
                );
            $(".menu-item-has-children")
                .find(".submenu-toggle-button")
                .on("click", function () {
