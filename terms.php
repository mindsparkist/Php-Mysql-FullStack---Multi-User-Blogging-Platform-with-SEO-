        ...
        <div class="container">
            <div class="single-post-wrap page-wrap">
                ...
                <div class="post-content m-auto">
                    ...
                    <p>Welcome to phptimes!</p>

                    <p>These terms and conditions outline the rules and regulations for the use of phptimes's Website,
                        located at http://localhost/blog/.</p>

                    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                        phptimes if you do not agree to take all of the terms and conditions stated on this page.</p>
                    ...
                    <p>We employ the use of cookies. By accessing phptimes, you agreed to use cookies in agreement with
                        the phptimes's Privacy Policy. </p>
                    ...
                    <p>Unless otherwise stated, phptimes and/or its licensors own the intellectual property rights for
                        all material on phptimes. All intellectual property rights are reserved. You may access this
                        from phptimes for your own personal use subjected to restrictions set in these terms and
                        conditions.</p>

                    <p>You must not:</p>
                    <ul>
                        <li>Republish material from phptimes</li>
                        <li>Sell, rent or sub-license material from phptimes</li>
                        <li>Reproduce, duplicate or copy material from phptimes</li>
                        <li>Redistribute content from phptimes</li>
                    </ul>
                    ...
                    <p>Parts of this website offer an opportunity for users to post and exchange opinions and
                        information in certain areas of the website. phptimes does not filter, edit, publish or review
                        Comments prior to their presence on the website. Comments do not reflect the views and opinions
                        of phptimes,its agents and/or affiliates. Comments reflect the views and opinions of the person
                        who post their views and opinions. To the extent permitted by applicable laws, phptimes shall
                    ...
                    <p>phptimes reserves the right to monitor all Comments and to remove any Comments which can be
                    ...
                    <p>You hereby grant phptimes a non-exclusive license to use, reproduce, edit and authorize others to
                    ...
                    <p>We will approve link requests from these organizations if we decide that: (a) the link would not
                        ...
                        hyperlink compensates the absence of phptimes; and (d) the link is in the context of general
                    ...
                    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to
                        our website, you must inform us by sending an e-mail to phptimes. Please include your name, your
                    ...
                    <p>No use of phptimes's logo or other artwork will be allowed for linking absent a trademark license
                        agreement.</p>
