...
if (isset($_POST['submitpost'])) {
    ...
    if (empty($errors)) {
        $queryparam = $_GET['edit'];
        $sql = "UPDATE `new_post` SET `datetime`='$datetime',`title`='$title',`category`='$category',`author`='$author',`image`='$imagePath',`post`='$description' WHERE `id`='$queryparam'";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form
                        action="editpost.php?edit=<?= $queryparam  ?>"
                        method="POST" enctype='multipart/form-data'>
                        <div class="form-group">
                            <label for="title">Title</label>
                            <input type="text"
                                value="<?= $updatedTitle ?>"
                                class="form-control" id="title" name="title" aria-describedby="title">
                        </div>
                        <div class="form-group">
                            <label for="category">
                                Select category
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="editor" rows="7" name="description">
                                <?= $updatedPost ?>
                            </textarea>
                        </div>
                        <button type="submit" name="submitpost" value="submitpost"
                            class="btn btn-outline-success btn-lg btn-block">Update</button>
                    </form>
                </div>
                <!-- /.container-fluid -->
